...
@time wp = WorkPrecisionSet(prob,abstols,reltols,setups;
                            ...
                            save_everystep=false, appxsol=test_sol, maxiters=Int(1e5));#500+s
...
@time wp = WorkPrecisionSet(prob,abstols,reltols,setups;
                            print_names=true, names=labels,
                            numruns=5, error_estimate=:l2,
                            save_everystep=false, appxsol=test_sol, maxiters=Int(1e5));#126s
...
@time wp = WorkPrecisionSet(prob,abstols,reltols,setups;
                            print_names=true, names=labels,
                            numruns=5, error_estimate=:l2,
                            save_everystep=false, appxsol=test_sol, maxiters=Int(1e5));#279s
